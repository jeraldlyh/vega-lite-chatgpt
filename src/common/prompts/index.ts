...
import {
  ...
  HISTOGRAM_CHART_HIGHLIGHT_PROMPTS,
...
export const PROMPT_MAPPING: Record<TGraph, IValue> = {
  ...
  histogram: {
    HIGHLIGHT: HISTOGRAM_CHART_HIGHLIGHT_PROMPTS,
    IN: HISTOGRAM_CHART_IN_PROMPTS,
    WHERE: HISTOGRAM_CHART_WHERE_PROMPTS,
  },
};

...
export const GROUND_TRUTH_BAR_CHART_UTTERANCES = [
  // "In addition, generation exceeded consumption in all the countries except Germany.",
  // "The largest electricity value is production in China.",
  //   "The top values for electricity are 5398 and 5322 respectively.",
  //   "China and the United States led in both electricity output and use.",
  "Brazil, Germany and Korea were the lowest producers of electricity.",
  //   "The lowest values for electricity are 449.5 and 455.8 respectively.",
  //   "There was only one country which had readings that were more than 5000.",
  //   "The legend indicates that this bar chart has two categories.",
];

...
export const GROUND_TRUTH_PIE_CHART_UTTERANCES = [
  //   "Nearly 87% of respondents said they suffered massive or moderate disruptions to their sourcing, supplies and ability to conduct business.",
  //   "Some 24.3% characterized the disruption as massive.",
  //   "The largest section consisted of businesses experiencing moderate disruption.",
  "Businesses experiencing minor or no real disruptions were in the minority.",
  //   "The smallest section with any real disruption was only 11%.",
  //   "Nearly 98% of respondents said they suffered some sort of disruption to their business, be it massive, moderate, or minor disruptions.",
  //   "Only 2.2% said they experienced no real disruptions in the supply chain for their businesses.​",
  //   "The legend shows that this pie chart is made up of 4 categories.",
];
